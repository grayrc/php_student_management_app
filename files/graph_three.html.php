...
<meta name="description" content="graph three">
...
<link href="css/style.css" rel="stylesheet">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        // Set chart options
        var options = { title: "Student average over all labs",
                        width:700,
                        height :700,
                        curveType: 'function',
  ...
  <div class="row">
    ...
    <div class="col-md-6 content">
      <div class="page-header">
        <h1>
          Graph of average responses over all labs for one descriptor
